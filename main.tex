...
\author{Felipe Sepulveda de Faria}{\input{elementos-pretextuais/agradecimentos}}
...
\advisor[Prof.]{Silvana Rossetto,~D.Sc.}{}

% co-orientador é opcional
%\advisor[Prof.]{Aloísio Carlos de Pina,~D.Sc.}{}

% máximo de 3 integrantes da banca (orientador e co-orientador já são adicionados automaticamente)
\banca[Prof.]{Adriano Joaquim de Oliveira Cruz,~Ph.D}{DCC~-~UFRJ}
\banca[Prof.]{João Carlos Pereira da Silva,~D.Sc.}{DCC~-~UFRJ}
